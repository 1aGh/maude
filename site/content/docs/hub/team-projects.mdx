...
On Maude Cloud the project owner switches an existing project to accepted revisions from the dashboard: open the project, **Saving → Preview the switch → Switch to accepted revisions**. Operators of a self-hosted server follow the [rollout runbook](https://github.com/1aGh/maude/blob/main/docs/operations/project-multiplayer-rollout.md).
